    ...
    <div class="container">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            <div class="card-group">
                <div class="card p-4">
                    <h1 style="text-align: center">ระบบตรวจสอบภาษีที่ดิน</h1>
                    <div class="card-body">
                        <h6 class="text-danger text-center">
                            {{Session::get('error_login')}}
                        </h6>
                        <form method="POST" action="{{url('landcheck')}}">
                            @csrf
                      ...
                      <span class="input-group-text">
                        <svg class="c-icon">
                          <use xlink:href="assets/icons/coreui/free-symbol-defs.svg#cui-lock-locked"></use>
                                ...
                                <input class="form-control col-lg-8 col-md-8 col-sm-12" type="text" name="password" placeholder="เลขที่ดิน" required oninvalid="this.setCustomValidity('กรุณากรอกเลขที่โฉนดที่ดิน')"
                                       oninput="this.setCustomValidity('')"/>
                            </div>
                                <div class="row">
                                    <div class="col-12" style="display: flex;justify-content: center;">
                                        <button style="width: 50%" type="submit" id="submitButton" class="btn btn-primary" value="card_id"><span class="cil-search btn-icon mr-2"></span>ตรวจสอบภาษี</button>
                                    </div>
                                </div>
