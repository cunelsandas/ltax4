          ...
          <div class="animated fadeIn">
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header" style="text-decoration: underline"><h4>รายชื่อผู้ชำระภาษีอาคารและสิ่งปลูกสร้าง ประจำปี พ.ศ. {{\Illuminate\Support\Carbon::now()->year+543}}</h4></div>
                    <div class="card-body">
{{--                        <div class="row">--}}
...
{{--                            <th></th>--}}
                            ...
                            <tbody>
                            <a href="{{ url('/reports/1/namepaybuild') }}" class="btn btn-block btn-primary"><span class="cil-library-building btn-icon mr-2"></span>พิมพ์รายงานรายชื่อผู้ชำระภาษีอาคารและสิ่งปลูกสร้าง</a>
                            @foreach($namepaybuild as $key => $gdt)
                                <tr>
                                    <td>
                                        {{$namepaybuild->firstItem()+$key}}
                                    </td>
                                    ...
                                    <td>
                                        {{ $gdt->baddress }} ม.{{ $gdt->bmoo }} ซ.{{ $gdt->bsoi }} ถ.{{ $gdt->broad }} ต.{{ $gdt->tambon_name }}
                                    </td>
                                    <td>
