    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header" style="text-decoration: underline"><h4>ราคาประเมินทุนทรัพย์ห้องชุดตามกฎหมายว่าด้วยอาคารชุด (ภ.ด.ส. 2)</h4></div>
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i>{{ __('ค้นหาข้อมูล ภ.ด.ส.2') }}</div>
                    <div class="card-body">
        <div class="col-md-12">
            ...
            <table class="table table-responsive-sm table-striped">
                ...
                @foreach($getData as $gdt)
                    <tr>
                        ...
                        {{--                              </td>--}}
                        <td>
                            <a href="{{ url('/reports/' . $gdt->owner_id.'/pds2') }}" class="btn btn-block btn-primary"><span class="cil-library-building btn-icon mr-2"></span>ดูรายงาน ภ.ด.ส. 2</a>
                        </td>
                        {{--                              <td>--}}
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card" style="border: solid 2px black">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i>{{ __('ราคาประเมินทุนทรัพย์ห้องชุดตามกฎหมายว่าด้วยอาคารชุด (ภ.ด.ส. 2)') }}</div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <br>
                                <table class="table table-responsive-sm table-striped">
