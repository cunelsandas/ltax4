            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i>{{ __('ค้นหาข้อมูล ภ.ด.ส.1') }}</div>
                    <div class="card-body">
        <div class="col-md-12">
            ...
            <table class="table table-responsive-sm table-striped">
                ...
                @foreach($getData as $key => $gdt)
                    <tr>
                        ...
                        {{--                              </td>--}}
                        <td>
                            <a href="{{ url('/reports/' . $gdt->owner_id.'/pds1') }}" class="btn btn-block btn-primary"><span class="cil-library-building btn-icon mr-2"></span>ดูรายงาน ภ.ด.ส. 1</a>
                        </td>
                        {{--                              <td>--}}
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card" style="border: solid 2px black">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i>{{ __('ราคาประเมินทุนทรัพย์ของที่ดินและสิ่งปลูกสร้าง (ภ.ด.ส.1)') }}</div>
                        <div class="card-body">
                            <div class="col-md-12">
{{--                                <input type="text"  class="form-control" placeholder="ค้นหาด้วย เลขบัตรประชา, ชื่อ, นามสกุล, เลข ผ.ท.4, ที่อยู่" wire:model="searchTerm" />--}}
                                <br>
