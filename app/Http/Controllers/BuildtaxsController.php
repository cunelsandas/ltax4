...
class BuildtaxsController extends Controller
{
...
//
//        }
        $getData = DB::table('ltax_building')->paginate( 50 );
        return view('dashboard.buildtaxs.buildtaxsList', ['getData' => $getData]);
    }
    ...
    {
        $statuses = Status::all();
        return view('dashboard.buildtaxs.create', [ 'statuses' => $statuses ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('buildtaxs.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard.buildtaxs.buildtaxsShow', [ 'note' => $note ]);
    }
    ...
    public function edit($id)
    {
        ...
        $statuses = Status::all();
        return view('dashboard.buildtaxs.edit', [ 'statuses' => $statuses, 'getData' => $getData ,'ownerData'=>$ownerData,'titleData'=>$titleData,'tambonData'=>$tambonData,
