...
//        dd($getCondoData);
        ...
        return view('condo.index',['getData'=>$getData,'ownerData'=>$ownerData,'getCondoFromPDS4'=>$getCondoFromPDS4,'getDistrict'=>$getDistrict,
            'getCondoData'=>$getCondoData]);
    ...
    public static function print_pds4($id)
    {
        ...
        $ownerData = DB::table('owner')->where('owner_id','=', $getData->owner_id)->first();
        $getCondoData = DB::table('cd_room')->where('cdrid','=',$getData->cdroid)->first();
        $getCondoFromPDS4 = DB::table('pds4')->where('ref_cdr_id','=', $getData->cdr_id)->orderBy('id','desc')->first();
        $getDistrict = DB::table('districts')->where('district_code','=', $ownerData->tambon_id)->first();

         //dd($getCondoFromPDS4);

        return view('condo.print_inpds4', ['getData',$getData,'ownerData'=>$ownerData,'getCondoData'=>$getCondoData,'getCondoFromPDS4'=>$getCondoFromPDS4,'getDistrict'=>$getDistrict]);
    }
