...
class LandtaxsController extends Controller
{
...
//
//        }
        $getData = DB::table('ltax_land')->paginate( 50 );

        return view('dashboard.landtaxs.landtaxsList', ['getData' => $getData]);
    }
    ...
    {
        $statuses = Status::all();
        return view('dashboard.landtaxs.create', [ 'statuses' => $statuses ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('landtaxs.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard.landtaxs.landtaxsShow', [ 'note' => $note ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.landtaxs.edit', [ 'statuses' => $statuses, 'getData' => $getData ,'ownerData'=>$ownerData,'titleData'=>$titleData,'tambonData'=>$tambonData,
